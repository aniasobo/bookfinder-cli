...
describe('addToList', () => {
  it('should print success message to stdout', async () => {
    ...
    await addToList('firstTerm secondTerm 1');
...
// test internal functions - pass file name to the test - function saveToReadingList takes filename as argument, only the addToList function passes it the right name, but test can use another